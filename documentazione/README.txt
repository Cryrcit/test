la creazione della tabella (tabella) può essere divisa in due tabelle, esportando le valute in una altra tabella
che appunto contiene tutte le valute (stringa e simbolo).
